...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG", "MIT-LICENSE", "README.rdoc", "Rakefile", "authorization_rules.dist.rb", "garlic_example.rb", "init.rb", "app/views", "app/views/authorization_usages", "app/views/authorization_usages/index.html.erb", "app/views/authorization_rules", "app/views/authorization_rules/index.html.erb", "app/views/authorization_rules/graph.dot.erb", "app/views/authorization_rules/graph.html.erb", "app/controllers", "app/controllers/authorization_rules_controller.rb", "app/controllers/authorization_usages_controller.rb", "app/helpers", "app/helpers/authorization_rules_helper.rb", "config/routes.rb", "lib/in_controller.rb", "lib/reader.rb", "lib/rails_legacy.rb", "lib/obligation_scope.rb", "lib/in_model.rb", "lib/helper.rb", "lib/authorization.rb", "lib/maintenance.rb", "test/authorization_test.rb", "test/schema.sql", "test/maintenance_test.rb", "test/model_test.rb", "test/controller_test.rb", "test/helper_test.rb", "test/dsl_reader_test.rb", "test/test_helper.rb"]
  s.has_rdoc = true
